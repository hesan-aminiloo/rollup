...
var Joi = require('joi');
var registerUserSchema = Joi.object({
    username: Joi
        .string()
        .alphanum()
        .min(3)
...
var isRegisterDataValid = function (userData) { return __awaiter(void 0, void 0, void 0, function () {
    var isValid;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, registerUserSchema.validateAsync(userData)];
            case 1:
                isValid = _a.sent();
...
/** Main base url */
var BASE_URL = 'https://umon.com/api/v1/';
var AUTH_REGISTER_API = "".concat(BASE_URL, "/register");

var RegisterUser = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    var data, E_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                if (!isRegisterDataValid(formData))
                    return [2 /*return*/, Promise.reject('Invalid arguments')];
                return [4 /*yield*/, axios.post(AUTH_REGISTER_API, formData)];
            case 1:
                data = (_a.sent()).data;
                console.log(data);
...
var LoginWithUserPass = function () {
};
...
var trackEvent = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, E_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios.get('https://swapi.dev/api/people/1')];
            case 1:
                data = (_a.sent()).data;
                return [2 /*return*/, data];
            case 2:
...
var helpers = /*#__PURE__*/Object.freeze({
    ...
    daysToYears: daysToYears
});

export { auth as Auth, helpers as Helpers };
